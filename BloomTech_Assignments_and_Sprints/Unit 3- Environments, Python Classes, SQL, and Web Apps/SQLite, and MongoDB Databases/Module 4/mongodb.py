...
def create_mdb_conn(password, dbname):
    client = pymongo.MongoClient(f'''mongodb+srv://Willis_BT:{password}@cluster0.algl5.mongodb.net/{dbname}?retryWrites=true&w=majority''')
    return client
...
if __name__ == '__main__':
    ...
    #Connection to desired collection
    db = client.rpg_data
    col = db['rpg_data']
    #drop anything already there
    #db.drop({})
